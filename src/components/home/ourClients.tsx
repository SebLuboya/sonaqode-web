  ...
  return (
    <section className="pt-28">
      <div className="relative w-full max-w-[1210px] min-h-[650px] mx-auto py-16 px-4 rounded-[100px] bg-sona-lightBlue">
        <div className="max-w-[986px] mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-row w-full gap-10 my-16">
            {clients.map((item) => (
              <div
                key={item.label}
                className="relative flex flex-1 aspect-[530/390] bg-emerald-600 rounded-[50px] overflow-clip"
              >
                <Image
                  src={item.image}
                ...
                <motion.div
                  ...
                  className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-end gap-1.5 pb-16 bg-black/50 text-white"
                >
                  <p className="font-clash text-center font-medium text-2xl">
                    {item.label}
                  </p>
