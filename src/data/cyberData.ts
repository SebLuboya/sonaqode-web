    ...
    skillSet: [
      {
        ...
        values: [
          ...
          "Networking: Understanding network protocols, security groups, firewalls, and VPNs.",
    ...
    skillSet: [
      {
        ...
        values: [
          ...
          "Database Design: Creating optimal database schemas and indexes.",
          "Performance Tuning: Optimising database performance through query optimisation, indexing, and hardware/software configurations.",
          "Backup and Recovery: Implementing and testing backup and recovery procedures.",
          "Data Security: Ensuring data confidentiality, integrity, and availability through access controls, encryption, and other security measures.",
    ...
    skillSet: [
      {
        ...
        values: [
          ...
          "Security Tools: Expertise in using penetration testing tools Burp Suite, Metasploit, Nmap, Kali Linux.",
